...
<div class="row">
    <p class="bg-success" style="padding:10px;margin-top:20px">Extrapolando, si suponemos un volumen de facturación de 100.000 €/mes, esto equivale a una pérdida de {{number_format($control->promedio*100000, 0, ',', '.')}} €/mes</p>
</div>
<!--
<script>
