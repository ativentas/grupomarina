...
$client->setClientId('318065982030-qqmkdkqdsqkfjqcetk277m56nhslb5gp.apps.googleusercontent.com');
$client->setClientSecret('8yFJlhyNFeULgwHtkPGSRAFx');
$client->setRedirectUri($config['http://pedidos.dev:8000/testGmail.php']);
